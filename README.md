...
**Это имеется ввиду в стилях для тегов, типа ```css
<h2>
``` -> h2 {font-size:..., color: ...}?**
...
**Т.е. если абсолютно одинаковый стиль для заголовка второго уровня прописать ```htm
 <h2 class="style-h2">
```, и уже в CSS задавать .style-h2{font-size:..., color: ...}?**
